...
- 当前 `main` 已同步到 `b11b8d08d8b4aba1a96a1b14aa33227f95f71368`，运行 `35565226085` 的质量与发布两个 job 均为 `success`。
- 当前发布候选工件 id `10623912039`、摘要 `sha256:22563f7a3cb05103e3af00e89f64a2017deb16d9b5c094cfecb57fccbc1cc5fd` 已归档；现场部署仍受“镜像只在 runner 构建、不推送仓库”和正式 HTTPS/主机条件限制。
