...
- 当前 `main` 已同步到 `9bd7fc741cd5bd6641841b5e7296f10425d50d10`，运行 `35568024843` 的质量与发布两个 job 均为 `success`。
- 当前发布候选工件 id `10624507458`、摘要 `sha256:8b3882aeaa7c77fe0a6744c237636374531715648cf8b7a33452b02f57119590` 已归档；现场部署仍受“镜像只在 runner 构建、不推送仓库”和正式 HTTPS/主机条件限制。
