...
export function JobList({ jobs, sections, selectedId, onSelect, onDeleted }: { jobs: Job[]; sections: AnalysisSection[]; selectedId?: string; onSelect: (id: string) => void; onDeleted: (ids: string[]) => void }) {
