      ...
      : <div className="knowledge-table-scroll">
        <table className="knowledge-item-table">
          <thead><tr>
            ...
            {["hot-topic", "lost-deal"].includes(base.sectionId) && <th title="按当前关联的不同记录计数；同一记录重试不重复计数">关联记录数</th>}
          ...
          >
            ...
            {["hot-topic", "lost-deal"].includes(base.sectionId) && <td>{item.occurrenceCount ?? 0}</td>}
